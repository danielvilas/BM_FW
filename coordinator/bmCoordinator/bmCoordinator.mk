...
Objects0=$(IntermediateDirectory)/remote_proc.c$(ObjectSuffix) $(IntermediateDirectory)/proc_common.c$(ObjectSuffix) $(IntermediateDirectory)/config.c$(ObjectSuffix) $(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/datalogger.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/config.c$(ObjectSuffix): config.c $(IntermediateDirectory)/config.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/Volumes/Datos/Daniel/GoogleDrive/DoctoradoDB/Articulo1/code/BM_FW/coordinator/bmCoordinator/config.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/config.c$(ObjectSuffix) $(IncludePath)
