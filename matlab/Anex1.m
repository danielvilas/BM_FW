...
fbf_PrintTextTable([rpi_C_Mqtt rpi_Java_Mqtt rpi_Node_Mqtt rpi_Python_Mqtt;bbb_C_Mqtt bbb_Java_Mqtt bbb_Node_Mqtt bbb_Python_Mqtt],fid);
fprintf(fid,tableend,"mqtt");

fprintf(fid,tablehead,"Raspberry/BeagleBone Rest Comparative");
fbf_PrintTextTable([rpi_C_Rest rpi_Java_Rest rpi_Node_Rest rpi_Python_Rest;bbb_C_Rest bbb_Java_Rest bbb_Node_Rest bbb_Python_Rest],fid);
fprintf(fid,tableend,"rest");

fprintf(fid,tablehead,"Raspberry/BeagleBone Soap Comparative");
fbf_PrintTextTable([rpi_C_Soap rpi_Java_Soap rpi_Node_Soap rpi_Python_Soap;bbb_C_Soap bbb_Java_Soap bbb_Node_Soap bbb_Python_Soap],fid);
